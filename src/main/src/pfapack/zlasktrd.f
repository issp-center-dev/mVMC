...
*              We need to multiply with v^*
               ...
               CALL ZSKMV( 'Upper', I-1, DCONJG(TAU(I-1)), A, LDA,
     $                     A( 1, I ), 1, ZERO, W( 1, NB-NW ), 1 )
               IF( NW .GT. 0 ) THEN
                  CALL ZGEMV( 'Transpose', I-1, NW, ONE,
     $                        W( 1, NB-NW+1 ), LDW, A( 1, I ), 1, ZERO,
     $                        W( I+1, NB-NW ), 1 )
                  CALL ZGEMV( 'No transpose', I-1, NW, DCONJG(TAU(I-1)),
...
*              complex conjugate of v
               ...
               CALL ZSKMV( 'Lower', N-I, DCONJG(TAU( I )),
     $                     A( I+1, I+1 ), LDA,
     ...
     $                 W( 1, NW+1 ), 1 )
                  CALL ZGEMV( 'No transpose', N-I, NW, DCONJG(TAU( I )),
