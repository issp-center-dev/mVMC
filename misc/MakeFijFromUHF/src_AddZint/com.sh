...
# [Fos  seq] icc UHFmain.c  -openmp -openmp-report2  -O3 -LKLPATH -IKLINCLUDE -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread -o UHF
icc UHFmain.c  -openmp -openmp-report2  -O3 -LKLPATH -IKLINCLUDE -lmkl_intel_lp64 -lmkl_intel_thread -lmkl_core -lpthread -o UHF
