...
double *SROptHcO; /* [SROptSize]            < HcO > */
double *SROptHkO; /* [SROptSize]            < HkO > */
...
double *LSHHHH;  /* [(3+NSplitSize)*(3+NSplitSize)] w + H + HcH + HkH */
double *LSHH_Store;  /* [(3+NSplitSize)*NVMCSample] w + H + HcH + HkH */
double *w_Store;  /* [NVMCSample] calculation buffar */
double *H_Store;  /* [NVMCSample] calculation buffar */
double *HcH_Store;  /* [NVMCSample] calculation buffar */
double *HkH_Store;  /* [NSplitSize*NVMCSample] calculation buffar */
/***** Output File *****/
/* FILE *FileCfg; */
FILE *FileOut;
FILE *FileVar;
