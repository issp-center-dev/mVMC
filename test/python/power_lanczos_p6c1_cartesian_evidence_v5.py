#!/usr/bin/env python3
"""Recover and validate the P6-C1 v5 run after the v3 checker failure."""
...
DESIGN = PROJECT / "docs" / "2026-08-21-power-lanczos-p6c1-v5-control-remediation-design.md"
DEFAULT_INPUT = POLICIES / "power-lanczos-p6c1-cartesian-input-v5.txt.gz"
DEFAULT_SERIAL = POLICIES / "power-lanczos-p6c1-cartesian-serial-v5.txt.gz"
DEFAULT_MPI2 = POLICIES / "power-lanczos-p6c1-cartesian-mpi2-v5.txt.gz"
DEFAULT_MPI4 = POLICIES / "power-lanczos-p6c1-cartesian-mpi4-v5.txt.gz"
DEFAULT_EVIDENCE = POLICIES / "power-lanczos-p6c1-cartesian-evidence-v5.json"
ATTEMPT_CLAIM = (
    POLICIES / "power-lanczos-p6c1-cartesian-attempt-v5.json")
PRE_EXECUTION_MANIFEST = (
    POLICIES / "power-lanczos-p6c1-cartesian-pre-execution-manifest-v5.json")
DEFAULT_MANIFEST = (
    POLICIES / "power-lanczos-p6c1-cartesian-post-result-manifest-v5.json")
FAILURE_STDOUT = (
...
CONTROL_VALIDATOR = (
    POLICIES / "validate_power_lanczos_p6c1_control_v5.py")
...
def build_attempt_claim(executable_sha256: str,
    ...
    return {
        "schema_version": 4,
        "attempt_id": "power_lanczos_p6c1_cartesian_attempt_v5",
        ...
        "success_next_phase": "p6_c1_v5_independent_recovery_review",
        "failure_next_phase": "p6_c1_v5_independent_failure_review",
    }
...
def build_cartesian_evidence(
    ...
    result = {
        "schema_version": 4,
        "evidence_id": "power_lanczos_p6c1_cartesian_evidence_v5",
...
def build_failure_manifest(
    ...
    return {
        "schema_version": 4,
        "manifest_id": "power_lanczos_p6c1_cartesian_failure_v5",
