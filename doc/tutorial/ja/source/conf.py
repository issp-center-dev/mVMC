...
htmlhelp_basename = 'tutorial_mVMC_endoc'
...
latex_documents = [
    ('index', 'tutorial_mVMC.tex', u'mVMC Tutorial',
...
man_pages = [
    (master_doc, 'tutorial_mVMC', u'mVMC Tutorial',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tutorial_mVMC', u'mVMC Tutorial',
     author, 'userguide_mVMC', 'One line description of project.',
     'Miscellaneous'),
]
