...
During the calculation, the following file is outputted:\\
\begin{minipage}{12cm}
  \begin{screen}
\begin{verbatim}
zvo_SRinfo.dat
...
\verb|$ |\underline{Path}\verb|/vmc.out -e namelist.def zqp_opt.dat|
\small

After the calculation finishes, the following files are outputted.
\\
\begin{minipage}{12cm}
\begin{screen}
\begin{verbatim}
